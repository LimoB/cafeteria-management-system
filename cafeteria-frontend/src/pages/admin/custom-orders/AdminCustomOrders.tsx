    ...
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20 px-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-gray-100 pb-8 mt-10">
        ...
        <div className="bg-white px-8 py-5 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center gap-5">
          ...
          <div>
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">New Orders</p>
            <p className="text-2xl font-black text-gray-900 leading-none">
              {customOrders.filter(o => o.approvalStatus === 'pending').length}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col xl:flex-row justify-between gap-10">
              <div className="flex flex-col md:flex-row gap-10 flex-grow">
                ...
                <div className="space-y-6 flex-grow">
                  ...
                  <div className="bg-gray-50/70 p-6 rounded-[2rem] border border-gray-100 italic font-bold text-gray-700">
                    "{req.description}"
                  </div>
                ...
                {req.approvalStatus === 'pending' ? (
                  <div className="space-y-3">
                    <div className="relative group/input">
                      ...
                      <input 
                        type="number"
                        placeholder="Set Price (KES)"
                        value={orderPrices[req.id] || ''}
                        onChange={(e) => handlePriceChange(req.id, e.target.value)}
                        className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-black text-sm outline-none focus:bg-white focus:border-red-200"
                      />
                    </div>
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-grow bg-slate-900 text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-emerald-600 transition-all flex items-center justify-center gap-2"
                      >
                      ...
                      <button 
                        ...
                        className="p-4 bg-white border border-gray-200 rounded-2xl hover:bg-red-50 hover:text-red-600 transition-all"
                      >
                        <XCircle size={18} />
                      </button>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className={`p-5 rounded-[2rem] text-center border ${
                      ...
                      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-400 mb-1">Total Quoted</p>
